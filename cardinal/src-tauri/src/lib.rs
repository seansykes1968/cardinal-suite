...
use commands::{
    ...
    close_quicklook, copy_files_to_clipboard, get_app_status, get_finder_window_path,
    get_nodes_info, get_sorted_view, hide_main_window, list_subdirectories, normalize_watch_config,
