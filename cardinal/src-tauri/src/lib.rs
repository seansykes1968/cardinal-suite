...
use commands::{
    ...
    get_finder_window_path, hide_main_window, list_subdirectories, normalize_watch_config,
    open_in_finder, open_path, search, set_tray_activation_policy, set_watch_config,
